...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Row text(String txt , double fontsize , MainAxisAlignment align , FontWeight fw , Color colour , TextDecoration td){
    return Row(
  ...
  Column signupIcon({Color activeColour , Color disableColour , IconData icon , String txtToDisplay , Function onPressed}){
    return Column(
      children: <Widget>[
        IconButton(
              ...
              child: Padding(
                ...
                child: SingleChildScrollView(
                    ...
                    children: <Widget>[
                      ...
                      text("First Name" , 15.0 , MainAxisAlignment.start , FontWeight.w700 ,
                       Colors.black , null),

                      textField("Enter First Name", false, (String fnameText){
                        //code here
                      }),

                      text("Username" , 15.0 , MainAxisAlignment.start , FontWeight.w700 ,
                       Colors.black , null),
                      ...
                      text("Password" , 15.0 , MainAxisAlignment.start , FontWeight.w700 ,
                       Colors.black , null),
                      ...
                      text("OR", 13.0, MainAxisAlignment.center , FontWeight.bold ,
                       Colors.black , null),
